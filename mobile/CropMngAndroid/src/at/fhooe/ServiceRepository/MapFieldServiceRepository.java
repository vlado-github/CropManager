 ...
 */
public class MapFieldServiceRepository extends AsyncTask<String, Void, String>{
    public static final String svcUri = "http://10.0.2.2:81/MapFieldService.svc/web";
    public String result;

    @Override
    protected String doInBackground(String... strings) {
        if(strings[0].contains("SelectMapRecordsByFieldId")){
            return getAllMapRecordsByFieldId(strings[0]);
        }else{
            return null;
        }
    }
