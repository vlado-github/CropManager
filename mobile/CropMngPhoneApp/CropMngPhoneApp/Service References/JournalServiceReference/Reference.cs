...
// 
namespace CropMngPhoneApp.JournalServiceReference {
    ...
    public interface IJournalService {
        ...
        System.IAsyncResult BeginInsertJournal(CropMngPhoneApp.JournalServiceReference.Journal journal, System.AsyncCallback callback, object asyncState);
        ...
        CropMngPhoneApp.JournalServiceReference.Journal EndSelectJournalByCropId(System.IAsyncResult result);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IJournalServiceChannel : CropMngPhoneApp.JournalServiceReference.IJournalService, System.ServiceModel.IClientChannel {
    }
    ...
    public partial class SelectJournalByCropIdCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public CropMngPhoneApp.JournalServiceReference.Journal Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((CropMngPhoneApp.JournalServiceReference.Journal)(this.results[0]));
            }
        }
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class JournalServiceClient : System.ServiceModel.ClientBase<CropMngPhoneApp.JournalServiceReference.IJournalService>, CropMngPhoneApp.JournalServiceReference.IJournalService {
        ...
        System.IAsyncResult CropMngPhoneApp.JournalServiceReference.IJournalService.BeginInsertJournal(CropMngPhoneApp.JournalServiceReference.Journal journal, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginInsertJournal(journal, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        int CropMngPhoneApp.JournalServiceReference.IJournalService.EndInsertJournal(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginInsertJournal(object[] inValues, System.AsyncCallback callback, object asyncState) {
            CropMngPhoneApp.JournalServiceReference.Journal journal = ((CropMngPhoneApp.JournalServiceReference.Journal)(inValues[0]));
            return ((CropMngPhoneApp.JournalServiceReference.IJournalService)(this)).BeginInsertJournal(journal, callback, asyncState);
        }
        
        private object[] OnEndInsertJournal(System.IAsyncResult result) {
            int retVal = ((CropMngPhoneApp.JournalServiceReference.IJournalService)(this)).EndInsertJournal(result);
            return new object[] {
                    retVal};
        }
        ...
        public void InsertJournalAsync(CropMngPhoneApp.JournalServiceReference.Journal journal) {
            this.InsertJournalAsync(journal, null);
        }
        
        public void InsertJournalAsync(CropMngPhoneApp.JournalServiceReference.Journal journal, object userState) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult CropMngPhoneApp.JournalServiceReference.IJournalService.BeginSelectJournalByCropId(int crop_id, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginSelectJournalByCropId(crop_id, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CropMngPhoneApp.JournalServiceReference.Journal CropMngPhoneApp.JournalServiceReference.IJournalService.EndSelectJournalByCropId(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginSelectJournalByCropId(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((CropMngPhoneApp.JournalServiceReference.IJournalService)(this)).BeginSelectJournalByCropId(crop_id, callback, asyncState);
        }
        
        private object[] OnEndSelectJournalByCropId(System.IAsyncResult result) {
            CropMngPhoneApp.JournalServiceReference.Journal retVal = ((CropMngPhoneApp.JournalServiceReference.IJournalService)(this)).EndSelectJournalByCropId(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override CropMngPhoneApp.JournalServiceReference.IJournalService CreateChannel() {
            return new JournalServiceClientChannel(this);
        }
        
        private class JournalServiceClientChannel : ChannelBase<CropMngPhoneApp.JournalServiceReference.IJournalService>, CropMngPhoneApp.JournalServiceReference.IJournalService {
            
            public JournalServiceClientChannel(System.ServiceModel.ClientBase<CropMngPhoneApp.JournalServiceReference.IJournalService> client) : 
                    base(client) {
            }
            
            public System.IAsyncResult BeginInsertJournal(CropMngPhoneApp.JournalServiceReference.Journal journal, System.AsyncCallback callback, object asyncState) {
            ...
            public CropMngPhoneApp.JournalServiceReference.Journal EndSelectJournalByCropId(System.IAsyncResult result) {
                object[] _args = new object[0];
                CropMngPhoneApp.JournalServiceReference.Journal _result = ((CropMngPhoneApp.JournalServiceReference.Journal)(base.EndInvoke("SelectJournalByCropId", _args, result)));
                return _result;
            }
        }
    }
