...
// 
namespace PhoneApp1.MapFieldServiceReference {
    ...
    public interface IMapFieldService {
        ...
        System.IAsyncResult BeginInsertMapField(PhoneApp1.MapFieldServiceReference.MapField mapField, System.AsyncCallback callback, object asyncState);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMapFieldServiceChannel : PhoneApp1.MapFieldServiceReference.IMapFieldService, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MapFieldServiceClient : System.ServiceModel.ClientBase<PhoneApp1.MapFieldServiceReference.IMapFieldService>, PhoneApp1.MapFieldServiceReference.IMapFieldService {
        ...
        System.IAsyncResult PhoneApp1.MapFieldServiceReference.IMapFieldService.BeginInsertMapField(PhoneApp1.MapFieldServiceReference.MapField mapField, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginInsertMapField(mapField, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        int PhoneApp1.MapFieldServiceReference.IMapFieldService.EndInsertMapField(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginInsertMapField(object[] inValues, System.AsyncCallback callback, object asyncState) {
            PhoneApp1.MapFieldServiceReference.MapField mapField = ((PhoneApp1.MapFieldServiceReference.MapField)(inValues[0]));
            return ((PhoneApp1.MapFieldServiceReference.IMapFieldService)(this)).BeginInsertMapField(mapField, callback, asyncState);
        }
        
        private object[] OnEndInsertMapField(System.IAsyncResult result) {
            int retVal = ((PhoneApp1.MapFieldServiceReference.IMapFieldService)(this)).EndInsertMapField(result);
            return new object[] {
                    retVal};
        }
        ...
        public void InsertMapFieldAsync(PhoneApp1.MapFieldServiceReference.MapField mapField) {
            this.InsertMapFieldAsync(mapField, null);
        }
        
        public void InsertMapFieldAsync(PhoneApp1.MapFieldServiceReference.MapField mapField, object userState) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult PhoneApp1.MapFieldServiceReference.IMapFieldService.BeginDeleteMapField(int field_id, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginDeleteMapField(field_id, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        void PhoneApp1.MapFieldServiceReference.IMapFieldService.EndDeleteMapField(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginDeleteMapField(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((PhoneApp1.MapFieldServiceReference.IMapFieldService)(this)).BeginDeleteMapField(field_id, callback, asyncState);
        }
        
        private object[] OnEndDeleteMapField(System.IAsyncResult result) {
            ((PhoneApp1.MapFieldServiceReference.IMapFieldService)(this)).EndDeleteMapField(result);
            return null;
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult PhoneApp1.MapFieldServiceReference.IMapFieldService.BeginSelectMapRecordsByFieldId(int field_id, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginSelectMapRecordsByFieldId(field_id, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Collections.ObjectModel.ObservableCollection<int> PhoneApp1.MapFieldServiceReference.IMapFieldService.EndSelectMapRecordsByFieldId(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginSelectMapRecordsByFieldId(object[] inValues, System.AsyncCallback callback, object asyncState) {
            int field_id = ((int)(inValues[0]));
            return ((PhoneApp1.MapFieldServiceReference.IMapFieldService)(this)).BeginSelectMapRecordsByFieldId(field_id, callback, asyncState);
        }
        
        private object[] OnEndSelectMapRecordsByFieldId(System.IAsyncResult result) {
            System.Collections.ObjectModel.ObservableCollection<int> retVal = ((PhoneApp1.MapFieldServiceReference.IMapFieldService)(this)).EndSelectMapRecordsByFieldId(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override PhoneApp1.MapFieldServiceReference.IMapFieldService CreateChannel() {
            return new MapFieldServiceClientChannel(this);
        }
        
        private class MapFieldServiceClientChannel : ChannelBase<PhoneApp1.MapFieldServiceReference.IMapFieldService>, PhoneApp1.MapFieldServiceReference.IMapFieldService {
            
            public MapFieldServiceClientChannel(System.ServiceModel.ClientBase<PhoneApp1.MapFieldServiceReference.IMapFieldService> client) : 
                    base(client) {
            }
            
            public System.IAsyncResult BeginInsertMapField(PhoneApp1.MapFieldServiceReference.MapField mapField, System.AsyncCallback callback, object asyncState) {
